...
1. Owner: merge PR #3; then tag (`v0.2.1`) and reinstall the shared engine.
2. Lane A 5b inherited confirmation and 5c batch review; the review-packet renderer's citation
   lookup for secondary evidence tables; the `any_low` design question (K2); the item-5 list
