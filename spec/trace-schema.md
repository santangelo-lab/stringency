...
| `reviews` | yes | `reviewer`, `host`, `via`, `operator_session_ref`, `operator_harness` (from `STRINGENCY_OPERATOR`; migration 4), `verdict`, `correction_json`, `reason`, `reason_code` (reserved), bindings, `chosen_replicate` |
