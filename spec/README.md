...
| file | what |
|---|---|
| `roadmap-2026-09.md` | the plan approved on 2026-09-14 after the Phase A exit: Track 0 cleanup (done), Track 1 two-audience UX, Track 2 bulk RNA-seq plugin, Track 3 Lyons CLP spatial QC |
...
| `app1-spatial-qc-plan.md` | Track 3 in detail; section 4 holds the owner's decisions |
